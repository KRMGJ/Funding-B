...
public class UserController {
    ...
    @Operation(summary = "로그인 사용자 정보 조회", description = "현재 로그인한 사용자의 정보를 조회. 관리자인 경우 별도의 관리자 정보를 반환.",
    ...
    @Operation(summary = "최근 본 프로젝트 추가", description = "사용자가 최근에 본 프로젝트를 추가합니다. 비회원인 경우에도 동작합니다.",
            security = @SecurityRequirement(name = "bearerAuth"))
    @ApiResponses(value = {
    ...
    public ResponseEntity<ResponseDto<?>> addRecentViewProject(@Parameter(description = "프로젝트 ID", required = true)
    ...
    @Operation(summary = "최근 본 프로젝트 목록 조회", description = "사용자가 최근에 본 프로젝트 목록을 조회합니다.",
            security = @SecurityRequirement(name = "bearerAuth"))
    @ApiResponses(value = {
    ...
    public ResponseEntity<ResponseDto<String>> updateProfileImg(@io.swagger.v3.oas.annotations.parameters.RequestBody(description = "프로필 이미지 수정 요청 DTO", required = true,
                                                                        content = @Content(schema = @Schema(implementation = UserProfileImgDto.class)))
                                                                @Valid @ModelAttribute UserProfileImgDto dto,
                                                                @Parameter(hidden = true) @AuthenticationPrincipal CustomUserPrincipal principal
    ) throws Exception {
    ...
    public ResponseEntity<ResponseDto<String>> updatePassword(@io.swagger.v3.oas.annotations.parameters.RequestBody(description = "비밀번호 수정 요청 DTO", required = true,
                                                                      content = @Content(schema = @Schema(implementation = UserPasswordDto.class)))
    ...
    @Operation(summary = "사용자 좋아요 목록 조회", description = "사용자가 좋아요한 프로젝트 목록을 조회합니다.",
            security = @SecurityRequirement(name = "bearerAuth"))
    @ApiResponses(value = {
    ...
    @Operation(summary = "사용자 Q&A 목록 조회", description = "사용자가 작성한 Q&A 목록을 페이징 처리하여 조회합니다.",
            security = @SecurityRequirement(name = "bearerAuth"))
    @ApiResponses(value = {
    ...
    @Operation(summary = "프로젝트 좋아요", description = "사용자가 특정 프로젝트를 좋아요합니다.",
            security = @SecurityRequirement(name = "bearerAuth"))
    @ApiResponses(value = {
    ...
    public ResponseEntity<ResponseDto<Long>> likeProject(@Parameter(description = "프로젝트 ID", required = true) @PathVariable Long projectId,
                                                         @Parameter(hidden = true) @AuthenticationPrincipal CustomUserPrincipal principal
    ) {
        return userService.likeProject(principal.userId(), projectId);
    }

    @Operation(summary = "프로젝트 좋아요 취소", description = "사용자가 특정 프로젝트의 좋아요를 취소합니다.",
            security = @SecurityRequirement(name = "bearerAuth"))
    @ApiResponses(value = {
    ...
    public ResponseEntity<ResponseDto<Long>> dislikeProject(@Parameter(description = "프로젝트 ID", required = true) @PathVariable Long projectId,
                                                            @Parameter(hidden = true) @AuthenticationPrincipal CustomUserPrincipal principal
    ) {
        return userService.dislikeProject(principal.userId(), projectId);
    }

    @Operation(summary = "프로젝트 좋아요 여부 확인", description = "사용자가 특정 프로젝트를 좋아요했는지 여부를 확인합니다. 비회원인 경우 false를 반환합니다.",
            security = @SecurityRequirement(name = "bearerAuth"))
    @ApiResponses(value = {
    ...
    public ResponseEntity<ResponseDto<Boolean>> isProjectLiked(@Parameter(description = "프로젝트 ID", required = true) @PathVariable Long projectId,
                                                               @Parameter(hidden = true) @AuthenticationPrincipal CustomUserPrincipal principal
    ) {
        Long userId = principal != null ? principal.userId() : null;
    ...
    @Operation(summary = "크리에이터 팔로우", description = "사용자가 특정 크리에이터를 팔로우합니다.",
            security = @SecurityRequirement(name = "bearerAuth"))
    @ApiResponses(value = {
    ...
    public ResponseEntity<ResponseDto<String>> followCreator(@Parameter(description = "크리에이터 ID", required = true) @PathVariable Long creatorId,
                                                             @Parameter(hidden = true) @AuthenticationPrincipal CustomUserPrincipal principal
    ) {
        return userService.followCreator(principal.userId(), creatorId);
    }

    @Operation(summary = "크리에이터 팔로우 취소", description = "사용자가 특정 크리에이터의 팔로우를 취소합니다.",
            security = @SecurityRequirement(name = "bearerAuth"))
    @ApiResponses(value = {
    ...
    public ResponseEntity<ResponseDto<String>> unfollowCreator(@Parameter(description = "크리에이터 ID", required = true) @PathVariable Long creatorId,
                                                               @Parameter(hidden = true) @AuthenticationPrincipal CustomUserPrincipal principal
    ) {
        return userService.unfollowCreator(principal.userId(), creatorId);
    }

    @Operation(summary = "크리에이터 팔로우 여부 확인", description = "사용자가 특정 크리에이터를 팔로우했는지 여부를 확인합니다. 비회원인 경우 false를 반환합니다.",
            security = @SecurityRequirement(name = "bearerAuth"))
    @ApiResponses(value = {
    ...
    public ResponseEntity<ResponseDto<Boolean>> isFollowingCreator(@Parameter(description = "크리에이터 ID", required = true) @PathVariable Long creatorId,
                                                                   @Parameter(hidden = true) @AuthenticationPrincipal CustomUserPrincipal principal
    ) {
        Long userId = principal != null ? principal.userId() : null;
    ...
    @Operation(summary = "사용자 요약 정보 조회", description = "사용자의 요약 정보를 조회합니다.",
            security = @SecurityRequirement(name = "bearerAuth"))
    @ApiResponses(value = {
